...
export class CuacaComponent implements OnInit, AfterViewInit {
        ...
        [
          {
            ...
            "render" : function (data: string)
            {
              ...
              var html = waktu.local().format("YYY-MM-DD") + "<br />" + waktu.local().format("HH:mm") + " WIB";
              return html;
            }
          },
          {
  ...
  bind_table1() : void {
    this.http.get("http://api.openweathermap.org/data/2.5/forecast?id=1630789&appid=d17f58760d615c34a8a239851fc9cdd8  ")
    .subscribe((data: any) => {
      console.log(data);  
